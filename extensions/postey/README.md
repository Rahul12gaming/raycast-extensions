...
Create and manage social media drafts with [Postey](https://postey.ai), directly from Raycast.

## Setup

This extension requires a Postey API key. Get yours at [postey.ai → Settings → API](https://postey.ai/?settings=api), then paste it in the extension preferences.
